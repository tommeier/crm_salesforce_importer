...
=== TODO
  ...
  - Extensive tests across the importer
  - Allow passed custom columns (currently manually changing the properties)
...
=======
Salesforce::WsdlProperties.generate
This will generate a file : tmp/sales_force_import/dm_mapped_objects.rb for you to review and then override the plugin.
...
- Access Objects:
Salesforce::Objects::Account.first